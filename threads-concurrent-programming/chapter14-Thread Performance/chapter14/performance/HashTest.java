...
public class HashTest implements Runnable {
	...
	public static void main(String[] args) {
		...
		doTest(new Hashtable());
		hashNTS.stop();
		System.out.println("Standard hashtable (" + nThreads
				+ " threads) took " + hashNTS);
		...
		doTest(new ConcurrentHashMap());
		concNTS.stop();
		System.out.println("Concurrent hashmap (" + nThreads
				+ " threads) took " + concNTS);
